...
| `api.process.sequencing.add`       | Add sequencing library and sequencing run metadata      | `api/v2/process/sequencing/add/` |
...
### Add a sequencing run: `api.process.sequencing.add`
