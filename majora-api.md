...
| collection_date      |                               | Yes      | str:YYYY-MM-DD | The date the sample was collected. YYYY-MM-DD only. |
| adm1_region          |                               | Yes      | str:`UK-ENG`,`UK-SCT`,`UK-WLS`,`UK-NIR` ||
...
| source_sex           |                               | Yes      | str:`F`,`M`,`Other` | Sex of the patient |
| sample_type          |                               | No       | str:`swab`,`sputum`,`BAL`,`extract`,`culture` ||
| swab_site            |                               | No       | str:`nose`,`throat`,`nose-throat` ||
